...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script>
		KindEditor.ready(function(K) {
			var editor1 = K.create('textarea[name="weiquanneirong"]', {
