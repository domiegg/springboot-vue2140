...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateZoufangxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改走访信息<input type="hidden" name="id" value="${zoufangxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.biaoti.value='${zoufangxinxi.biaoti}';</script>	<script language="javascript">document.form1.shijian.value='${zoufangxinxi.shijian}';</script>	<script language="javascript">document.form1.didian.value='${zoufangxinxi.didian}';</script>	<script language="javascript">document.form1.zoufangrenyuan.value='${zoufangxinxi.zoufangrenyuan}';</script>	<script language="javascript">document.form1.xiangqing.value='${zoufangxinxi.xiangqing}';</script>	<script language="javascript">document.form1.faburen.value='${zoufangxinxi.faburen}';</script>	
					 </table>
			</form>
   </body>
</html>
