...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">走访信息列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="zoufangxinxiList2.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.biaoti}</td>    <td>${u.shijian}</td>    <td>${u.didian}</td>    <td>${u.zoufangrenyuan}</td>        <td>${u.faburen}</td>    
                              ...
                              <td align="center"><a href="doUpdateZoufangxinxi.do?id=${u.id }">编辑</a>  <a href="deleteZoufangxinxi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a href="zfxxDetail.do?id=${u.id }" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="zoufangxinxiList2.do?page=1" >首页</a>
             <a href="zoufangxinxiList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="zoufangxinxiList2.do?page=${page.page+1 }">下一页</a>
			<a href="zoufangxinxiList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
