			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="gongwenxinxiList.do" name="myform" method="post">
    ...
    <td align='center'>${u.issh} <input type="button" value="审核" onClick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=gongwenxinxi'"/></td>
		...
		统计数:共计<%=i %>条;
		 ...
		 <c:if test="${page.page>1}">
              <a href="gongwenxinxiList.do?page=1" >首页</a>
             <a href="gongwenxinxiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="gongwenxinxiList.do?page=${page.page+1 }">下一页</a>
			<a href="gongwenxinxiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
